...
//---
logDatasetValues(numberSets, getRandom);
logDatasetValues(stringSets, getRandom);
logDatasetValues(boolSets, getRandom);
//===================================
...
const users = [new User("Ivan"), new User("Olga")];
const products = [new Product("Ноутбук"), new Product("Смартфон")];
printAll(users);
printAll(products);
//===========================================
